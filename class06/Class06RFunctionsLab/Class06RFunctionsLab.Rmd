...
Follow the guidelines form class
...
We could try usng na.rm = TRUE argument, but this is not a good approach. 
...
```{r}
#' Calculate the average score for a vector of students' scores dropping the lowest score.
#' Missing values will be treated as zeroes.
#'
...
HW 5 has the highest correlation value. 
