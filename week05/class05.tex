...
\title{Class 5 Data Visualization Lab}
...
\hypersetup{
  pdftitle={Class 5 Data Visualization Lab},
  pdfauthor={Cindy Tran (A15830581)},
  hidelinks,
...
\CommentTok{\# Any time I want to use this pacakage, I need to load it}
\FunctionTok{library}\NormalTok{(ggplot2)}

\FunctionTok{View}\NormalTok{(cars)}

\CommentTok{\# A quick baseR plot {-} this is not ggplot}
...
\CommentTok{\# Our first ggplot}
  \CommentTok{\#We need data + aes + geom}
...
\NormalTok{p }\SpecialCharTok{+} \FunctionTok{geom\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Column names and number of columns}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#How many upreglated genes}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#Fraction of genes up{-}regulated}
...
\NormalTok{g }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data =}\NormalTok{ genes) }\SpecialCharTok{+}
  \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ Condition1, }\AttributeTok{y =}\NormalTok{ Condition2,}
...
\NormalTok{g }\SpecialCharTok{+} \FunctionTok{scale\_color\_manual}\NormalTok{(}\AttributeTok{values =} \FunctionTok{c}\NormalTok{(}\StringTok{"blue"}\NormalTok{, }\StringTok{"gray"}\NormalTok{, }\StringTok{"red"}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Gene Expression Changes Upon Drug Treatment"}\NormalTok{,}
       ...
       \AttributeTok{y =} \StringTok{"Drug Treatment"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{class05_files/figure-latex/\#-2.pdf}
